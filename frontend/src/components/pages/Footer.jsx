...
const Footer = () => {
    return (
        <div >
            <section className="relative overflow-hidden bg-white py-8 border-t-2 border-black">
                <div className="container relative z-10 mx-auto px-4">
                    <div className="-m-8 flex flex-wrap items-center justify-between">
                        <div className="w-auto p-8">
                            <Link to={"/"}>
                                <div className="inline-flex items-center">
                                    <h1 className='font-mono font-extrabold text-4xl'>HH</h1>
                                    <span className="ml-4 text-lg font-bold">Health Hub</span>
                                </div>
                            </Link>
                        </div>
                        <div className="w-auto p-8">
                            <ul className="-m-5 flex flex-wrap items-center">
                                <li className="p-5">
                                    <Link to={"/about"} className="font-medium text-gray-600 hover:text-gray-700" href="#">
                                        Privacy Policy
                                    </Link>
                                </li>
                                <li className="p-5">
                                ...
                                <li className="p-5">
                                    <Link to={"/contact"} className="font-medium text-gray-600 hover:text-gray-700" href="#">
                                        Contact Us
                                    </Link>
                                </li>
                            </ul>
